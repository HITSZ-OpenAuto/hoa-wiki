...
![](/images/upload-materials/fork-repo-actively.png)
...
![](/images/upload-materials/files-upload-button.png)
...
![](/images/upload-materials/open-pull-request.png)
...
![](/images/upload-materials/find-git-clone-url.png)
打开一个文件夹，在命令行运行：
...
![](/images/upload-materials/create-codespaces.png)
...
跳转完成后你将看到如下界面：
![](/images/upload-materials/codespaces-interface.png)
