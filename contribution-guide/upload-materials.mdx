...
![手动 Fork 仓库的入口](/images/upload-materials/fork-repo-actively.png)
...
![文件夹页面的「上传文件」按钮](/images/upload-materials/files-upload-button.png)
...
![发起 Pull Request 按钮](/images/upload-materials/open-pull-request.png)
...
![复制 git clone 链接的位置](/images/upload-materials/find-git-clone-url.png)
打开一个文件夹，在命令行运行：
`git clone <你刚刚复制的仓库链接>`
这样，**仓库就已经成为你的 `本地文件`**。在本地，你就可以随心所欲地进行各种修改，包括文档修改和文件上传。

> `本地文件` 指的是你存在自己电脑上、想要提交到我们的仓库里的文件。
...
![新建 Codespace 的入口](/images/upload-materials/create-codespaces.png)
...
跳转完成后你将看到如下界面：
![GitHub Codespaces 的编辑界面，含文件树、编辑区和终端](/images/upload-materials/codespaces-interface.png)
...
![GitHub Repositories 插件](/images/upload-materials/github-Repositories.png)

打开 [GitHub Repositories](https://marketplace.visualstudio.com/items?itemName=GitHub.remotehub) 插件，并登录自己的 GitHub 账号，打开对应仓库。

![通过 GitHub Repositories 打开远程仓库](/images/upload-materials/teach.png)
